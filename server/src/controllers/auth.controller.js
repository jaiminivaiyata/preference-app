...
const { authService, userService, tokenService, preferenceService } = require('../services');
...
const register = async (request, response) => {
  ...
  const preference = await preferenceService.getUserPreference(user);
  const responseObject = {
    code: httpStatus.CREATED,
    data: { user, tokens, preference : preference?.preference || null },
